...
2. **Wait for market close**; the extension stays fully idle during open hours (09:00–13:00 IRST) and only activates after 13:00 IRST (UTC+03:30), shutting down at the 07:00 deadline even if a crawl was still running.
